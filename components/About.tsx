    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          solving a complex and challenging real-world problems.
          <br /> <br /> Beyond my work in technology, I have a deep love for
          watching Movies. Whether it is watching with a{" "}
          <span className="text-blue-500 font-semibold">
            fresh cup of coffee!
          </span>
          <br />
          movies brings me a lot of joy!
        </p>
      </div>
    </motion.div>
  );
