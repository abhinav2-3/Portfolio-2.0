...
export const STACKS: stacksProps = {
  ...
  Vite: <SiVite size={iconSize} color="default" />,
  Prisma: <SiPrisma size={iconSize} color="default" />,
  Firebase: <SiFirebase size={iconSize} color="default" />,
  "Node.js": <SiNodedotjs size={iconSize} color="default" />,
  Redux: <SiRedux size={iconSize} color="default" />,
  Webpack: <SiWebpack size={iconSize} color="default" />,
  "Styled Components": <SiStyledcomponents size={iconSize} color="default" />,
  PWA: <SiPwa size={iconSize} color="default" />,
  Docker: <SiDocker size={iconSize} color="default" />,
  Nginx: <SiNginx size={iconSize} color="default" />,
  Postman: <SiPostman size={iconSize} color="default" />,
  Jest: <SiJest size={iconSize} color="default" />,
